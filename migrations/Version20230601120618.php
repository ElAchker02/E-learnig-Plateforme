 ...
 */
final class Version20230601120618 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // $this->addSql('CREATE TABLE chapitre (id INT AUTO_INCREMENT NOT NULL, nom_chap VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, video VARCHAR(255) DEFAULT NULL, documents JSON DEFAULT NULL, ord INT NOT NULL, id_cours INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        // $this->addSql('CREATE TABLE cours (id INT AUTO_INCREMENT NOT NULL, nom_cours VARCHAR(255) NOT NULL, introduction VARCHAR(255) NOT NULL, date_publication DATE NOT NULL, nb_chapitres INT NOT NULL, est_payant TINYINT(1) NOT NULL, prix NUMERIC(10, 0) DEFAULT NULL, id_categorie INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        // $this->addSql('CREATE TABLE partie (id INT AUTO_INCREMENT NOT NULL, description VARCHAR(255) DEFAULT NULL, images JSON DEFAULT NULL, info LONGTEXT DEFAULT NULL, avertissement LONGTEXT DEFAULT NULL, id_chapitre INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
